...
public class OMGLOL {
    public static void main(final String[] args) {
        final String original =
                "Oh my god my life isave no friends. I will always abhor you, in case you didn't know. By the way, you have some guests in the living room talking about how it is better safe than sorry to have a bodyguard in the alleys. Did you or did you not sign up for that summer job?";
